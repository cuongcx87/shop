...
class CouponsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'percent' => ['type' => 'float', 'length' => null, 'precision' => null, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => ''],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'time_start' => '2018-04-24 08:55:36',
                'time_end' => '2018-04-24 08:55:36',
                'created' => '2018-04-24 08:55:36',
                'modified' => '2018-04-24 08:55:36'
            ],
        ];
        parent::init();
    }
